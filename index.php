  ...
  <?php include 'theme/header.php'; //default admin header ?>
    ...
    <div class="content-wrapper p20">
      <div class="row">
      	<div class="col-md-4">
      	<div class="box box-solid bg-green-gradient" style="position: relative;">
      ...
      <div class="box box-info">
        ...
        <div class="box-body">
          <form action="system/mail-system.php" method="post">
